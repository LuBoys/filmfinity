...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        yield MenuItem::linkToRoute('Retour au site', 'fas fa-home', 'app_homepage');
        ...
        yield MenuItem::linkToCrud('Image', 'fas fa-comments', Image::class);
        yield MenuItem::linkToCrud('Note', 'fas fa-comments', Notes::class);
